            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('Manage Positions') }}</h5>
                        ...
                        <ul class="list-group">
                            @foreach ($positions as $position)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    {{ $position->name }}
                                    <div>
                                        <button wire:click="edit({{ $position->id }})" class="btn btn-sm btn-warning">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button wire:click="delete({{ $position->id }})" class="btn btn-sm btn-danger">
